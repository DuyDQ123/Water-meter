...
IMG_URL = 'https://cb70-123-19-58-38.ngrok-free.app/video_upload/video_stream/uploaded_image.jpg'
        ...
        try:
            ...
            if ocr_response.status_code == 200:
                ...
                result_response = urequests.post(
                    'http://192.168.136.1/video_upload/post.php', json=result_payload)
    ...
    while True:
        ...
        try:
            ...
            response = urequests.post(
                'http://192.168.136.1/video_upload/post.php', data=data, headers=headers)
